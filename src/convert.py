...
def convert_and_upload_supervisely_project(
    ...
    ok = sly.ObjClass("ok", sly.Rectangle)
    none = sly.ObjClass("none", sly.Rectangle)
    wrong = sly.ObjClass("wrong", sly.Rectangle)

    idx_to_class = {0: ok, 1: none, 2: wrong}
    ...
    for ds_name in os.listdir(dataset_path):
        ...
        if dir_exists(curr_ds_path):
            ...
            curr_anns_path = os.path.join(curr_ds_path, bboxes_folder)
